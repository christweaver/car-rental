    ...
    <div className="bg-zinc-100">
      ...
      <div className="flex flex-col justify-center items-center w-11/12 ml-16">
        {carOptions.map((carInfo, index) => (
          <div
            key={index}
            className="flex flex-row bg-white border-2 rounded-xl w-11/12 mt-8 hover:shadow-xl mb-4 h-60" // Set a fixed height (adjust as needed)
          >
            ...
            <div className="flex flex-col w-1/3 items-center">
              ...
              <div className="flex flex-row  border-gray-300 border-t-2">
                <h2 className="mr-2 text-[32px] font-semibold font-sans">
                  ${carInfo.rentalPrice}
                </h2>

                <h2 className="mr-4 text-[18px] text-gray-500 mt-3">Per day</h2>
              </div>
              <button
                onClick={() => handleSearchButtonClick(carInfo)}
